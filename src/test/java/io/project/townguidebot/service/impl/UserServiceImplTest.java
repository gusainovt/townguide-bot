...
class UserServiceImplTest {
    ...
    void registeredUser_ShouldCreateAndSaveUserFromChat() {
        ...
        assertEquals(chat.getFirstName(), saved.getFirstName());
        assertEquals(chat.getLastName(), saved.getLastName());
        assertEquals(chat.getUserName(), saved.getUserName());
